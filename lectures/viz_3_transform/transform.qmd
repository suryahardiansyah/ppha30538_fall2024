...
alt.Chart(movies_url).mark_area().encode(
    alt.X('month(Release_Date):T'), # altair is super smart that it can detect date in string
    # alt.Y('max(US_Gross):Q') # wrong method since you can only get one highest point
    alt.Y('median(US_Gross):Q') # median helps aggregate and tackle outliers
)
```
